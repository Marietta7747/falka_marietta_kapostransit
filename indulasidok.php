...
/*--------------------------------------------------------------------------------------------------------JAVASCRIPT - DISPLAY ROUTES------------------------------------------------------------------------------------*/
            ...
            fetch('http://localhost:3000/api/buszjaratok')
                ...
                .then(data => {
                    ...
                    if (filteredRoutes.length > 0) {
                        ...
                        const groupedData = filteredRoutes.reduce((acc, item) => {
                        ...
                        renderStartTimes(groupedData, routeNumber, routeName);
                    } else {
        ...
        function renderStartTimes(groupedData, routeNumber, routeName, isForward) {
